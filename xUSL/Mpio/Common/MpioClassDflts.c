...
const MPIOCLASS_INPUT_BLK mMpioClassDflts = {
  ...
  .PcieLaneEqForcePreset8Gt = CONFIG_MPIO_GEN3_PCIE_FORCE_PRESET,
  .PcieLaneEqForcePreset16Gt = CONFIG_MPIO_GEN4_PCIE_FORCE_PRESET,
  .PcieLaneEqForcePreset32Gt = CONFIG_MPIO_GEN5_PCIE_FORCE_PRESET,
  .Master7bitSteeringTag = true,
  .AmdCXlEarlyLinkTraining = 0,
  .AmdHotPlugPDSettle = false,
  .AmdHotplugPortReset = 0,
  .AmdHotPlugSupport = 0xF,
  ...
  .CxlQosSchedGap = 0x00,
  .CxlQosVariableGap = false,
  .CxlQosRdspIncMode = false,
  .CxlQosTimerDecNum = 0x00,
  .CxlQosRdspIncNum = 0x00,
  .CxlQosWrrspIncNum = 0x00,
  .CfgSevSnpSupport = false,
  .CfgSevTioSupport = false,
  .PcieIdeCapSup = false,
  .SafeRecoveryBER = false,
  .PeriodicCal = false,
  .LimitHpDevicesToPcieBootSpeed = true,
  .CfgDxioCplTimeout = 0xff,
  .CfgDxioAllowCompPass = true,
  .AmdExposeSFIDRSSupport = false,
  .AmdExposeSFIOOBSupport = false,
  .CxlSyncHeaderByPassCompMode = true,
  .CfgPCntlDeskewEmptymode = true
};
